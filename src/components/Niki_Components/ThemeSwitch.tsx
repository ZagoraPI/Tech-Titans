...
export function ThemeSwitch() {
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <div className="flex items-center p-2 border-8 border-gray-800 dark:border-gray-800 rounded-lg hover:border-white">
        <Switch
          id="theme-switch"
          checked={isDarkMode}
          ...
          className={`${
            ...
            border border-gray-800 dark:border-gray-800 dark:bg-gray-600`}
        />
